...
/**
 * Represents the JavaScript callback `(bytesDownloaded: number, totalBytes: number) => void`.
...
fun interface Func_void_double_double: (Double, Double) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(bytesDownloaded: Double, totalBytes: Double): Unit
}
...
class Func_void_double_double_cxx: Func_void_double_double {
  ...
  @Keep
  override fun invoke(bytesDownloaded: Double, totalBytes: Double): Unit
    = invoke_cxx(bytesDownloaded,totalBytes)

  @FastNative
  private external fun invoke_cxx(bytesDownloaded: Double, totalBytes: Double): Unit
}
...
class Func_void_double_double_java(private val function: (Double, Double) -> Unit): Func_void_double_double {
  ...
  @Keep
  override fun invoke(bytesDownloaded: Double, totalBytes: Double): Unit {
    return this.function(bytesDownloaded, totalBytes)
  }
}
